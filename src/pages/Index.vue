    ...
    <section class="mx-auto bg-white lg:w-[800px]  shadow-lg rounded-md overflow-hidden   w-full  ">
      ...
      <article class="w-11/12 mx-auto">
        ...
        <div class="flex flex-wrap text-white button-list">
          <a class="px-2 py-1 bg-orange-400 rounded mr-1 mb-3 hover:bg-opacity-90" href="https://jq.qq.com/?_wv=1027&k=fJJNtknG" target="_blank">加入群聊</a>
          <a class="px-2 py-1 bg-red-400 rounded mr-1 mb-3 hover:bg-opacity-90" href="http://doc.5173kk.com" target="_blank">使用教程</a>
          <a class="px-2 py-1 bg-blue-400 rounded mr-1 mb-3 hover:bg-opacity-90" href="http://sport.520e.com.cn" target="_blank">自动版本</a>
          <a class="px-2 py-1 bg-green-400 rounded mb-3 hover:bg-opacity-90" href="https://gitee.com/xx668888/sportsAssistant" target="_blank">免费搭建</a>
        </div>
      ...
      <footer class="w-11/12 flex flex-col text-gray-600 leading-6 pb-5 justify-center items-center mx-auto">
        ...
        <p id="tj" style="display: unset">
          <a href="//v6.51.la/land/Jfv9hD2ux2pcDT9v" title="51la网站统计" target="_blank"><img src="//sdk.51.la/icon/3-1.png"></a>
        </p>
      </footer>
    </section>
  </main>
...
<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    script.src = '//sdk.51.la/js-sdk-pro.min.js?id=Jfv9hD2ux2pcDT9v&ck=Jfv9hD2ux2pcDT9v';
    script.type = "text/javascript";
    script.id = "LA_COLLECT";
    let tj = document.getElementById('tj');
    tj.insertBefore(script, tj.children[0]);
  });
